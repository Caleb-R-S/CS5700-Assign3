...
internal class WebServerShipmentTest {
    ...
    fun shipmentFactoryStandard() {
        ...
        val newShipment = WebServerShipment.shipmentFactory(initialUpdate, "standard")
    ...
    fun shipmentFactoryOvernight() {
        val initialUpdate = ShipmentUpdate("s100", "created", "processing", 10000)
        val newShipment = WebServerShipment.shipmentFactory(initialUpdate, "overnight")
    ...
    fun shipmentFactoryExpress() {
        val initialUpdate = ShipmentUpdate("s100", "created", "processing", 10000)
        val newShipment = WebServerShipment.shipmentFactory(initialUpdate, "express")
    ...
    fun shipmentFactoryBulk() {
        val initialUpdate = ShipmentUpdate("s100", "created", "processing", 10000)
        val newShipment = WebServerShipment.shipmentFactory(initialUpdate, "bulk")
    ...
    fun findShipmentNull() {
        val initialUpdate = ShipmentUpdate("s100", "created", "processing", 10000)
        val newShipment = WebServerShipment.shipmentFactory(initialUpdate, "bulk")
        val result = WebServerShipment.findShipment("s100")
        assertNull(result)
    }
    ...
    fun findShipmentNotNull() {
        val initialUpdate = ShipmentUpdate("s100", "created", "processing", 10000)
        val newShipment = WebServerShipment.shipmentFactory(initialUpdate, "bulk")
        WebServerShipment.addShipment(newShipment)
        val result = WebServerShipment.findShipment("s100")
